...
const HOLDINGS: HoldingDef[] = [
  { symbol: 'TCS', yahoo: 'TCS.NS', name: 'TCS Ltd.', country: 'India', quantity: 140, currency: 'INR', assetClass: 'equity', basePrice: 3420, baseGain: 6.1 },
  { symbol: 'RELIANCE', yahoo: 'RELIANCE.NS', name: 'Reliance Industries', country: 'India', quantity: 80, currency: 'INR', assetClass: 'equity', basePrice: 2650, baseGain: 5.4 },
  { symbol: 'INFY', yahoo: 'INFY.NS', name: 'Infosys Ltd.', country: 'India', quantity: 110, currency: 'INR', assetClass: 'equity', basePrice: 1920, baseGain: 4.8 },
  { symbol: 'HDFCBANK', yahoo: 'HDFCBANK.NS', name: 'HDFC Bank', country: 'India', quantity: 90, currency: 'INR', assetClass: 'equity', basePrice: 1730, baseGain: 5.9 },
  { symbol: 'ICICIBANK', yahoo: 'ICICIBANK.NS', name: 'ICICI Bank', country: 'India', quantity: 120, currency: 'INR', assetClass: 'equity', basePrice: 905, baseGain: 4.6 },
  { symbol: 'HINDUNILVR', yahoo: 'HINDUNILVR.NS', name: 'Hindustan Unilever', country: 'India', quantity: 70, currency: 'INR', assetClass: 'equity', basePrice: 2680, baseGain: 3.7 },
  { symbol: 'BAJFINANCE', yahoo: 'BAJFINANCE.NS', name: 'Bajaj Finance', country: 'India', quantity: 45, currency: 'INR', assetClass: 'equity', basePrice: 7200, baseGain: 7.4 },
  { symbol: 'KOTAKBANK', yahoo: 'KOTAKBANK.NS', name: 'Kotak Mahindra Bank', country: 'India', quantity: 65, currency: 'INR', assetClass: 'equity', basePrice: 2120, baseGain: 4.2 },
  { symbol: 'MARUTI', yahoo: 'MARUTI.NS', name: 'Maruti Suzuki India', country: 'India', quantity: 55, currency: 'INR', assetClass: 'equity', basePrice: 10150, baseGain: 6.0 },
  { symbol: 'ASIANPAINT', yahoo: 'ASIANPAINT.NS', name: 'Asian Paints', country: 'India', quantity: 75, currency: 'INR', assetClass: 'equity', basePrice: 3450, baseGain: 5.8 },
...
const SWING_CANDIDATES = [
  { symbol: 'RELIANCE', name: 'Reliance Industries Ltd.', basePrice: 2450, yahoo: 'RELIANCE.NS' },
  { symbol: 'TCS', name: 'Tata Consultancy Services Ltd.', basePrice: 3400, yahoo: 'TCS.NS' },
  { symbol: 'INFY', name: 'Infosys Ltd.', basePrice: 1550, yahoo: 'INFY.NS' },
  { symbol: 'HDFCBANK', name: 'HDFC Bank Ltd.', basePrice: 1600, yahoo: 'HDFCBANK.NS' },
  { symbol: 'ICICIBANK', name: 'ICICI Bank Ltd.', basePrice: 920, yahoo: 'ICICIBANK.NS' },
  { symbol: 'TATAMOTORS', name: 'Tata Motors Ltd.', basePrice: 620, yahoo: 'TATAMOTORS.NS' },
  { symbol: 'SBIN', name: 'State Bank of India', basePrice: 580, yahoo: 'SBIN.NS' },
  { symbol: 'BHARTIARTL', name: 'Bharti Airtel Ltd.', basePrice: 870, yahoo: 'BHARTIARTL.NS' },
  { symbol: 'LT', name: 'Larsen & Toubro Ltd.', basePrice: 2350, yahoo: 'LT.NS' },
  { symbol: 'AXISBANK', name: 'Axis Bank Ltd.', basePrice: 960, yahoo: 'AXISBANK.NS' },
  { symbol: 'ITC', name: 'ITC Ltd.', basePrice: 440, yahoo: 'ITC.NS' },
  { symbol: 'MARUTI', name: 'Maruti Suzuki India Ltd.', basePrice: 9700, yahoo: 'MARUTI.NS' },
];

const MONTHLY_PERFORMER_CANDIDATES = [
  { symbol: 'COCHINSHIP', name: 'Cochin Shipyard Ltd.', basePrice: 1120, yahoo: 'COCHINSHIP.NS' },
  { symbol: 'MAZDOCK', name: 'Mazagon Dock Shipbuilders Ltd.', basePrice: 1850, yahoo: 'MAZDOCK.NS' },
  { symbol: 'RVNL', name: 'Rail Vikas Nigam Ltd.', basePrice: 125, yahoo: 'RVNL.NS' },
  { symbol: 'BEL', name: 'Bharat Electronics Ltd.', basePrice: 130, yahoo: 'BEL.NS' },
  { symbol: 'HAL', name: 'Hindustan Aeronautics Ltd.', basePrice: 2800, yahoo: 'HAL.NS' },
  { symbol: 'TRENT', name: 'Trent Ltd.', basePrice: 2050, yahoo: 'TRENT.NS' },
  { symbol: 'ADANIPOWER', name: 'Adani Power Ltd.', basePrice: 320, yahoo: 'ADANIPOWER.NS' },
  { symbol: 'IREDA', name: 'Indian Renewable Energy Dev Agency', basePrice: 105, yahoo: 'IREDA.NS' },
  { symbol: 'TATASTEEL', name: 'Tata Steel Ltd.', basePrice: 118, yahoo: 'TATASTEEL.NS' },
  { symbol: 'JIOFIN', name: 'Jio Financial Services Ltd.', basePrice: 245, yahoo: 'JIOFIN.NS' },
  { symbol: 'BHEL', name: 'Bharat Heavy Electricals Ltd.', basePrice: 110, yahoo: 'BHEL.NS' },
  { symbol: 'PFC', name: 'Power Finance Corporation Ltd.', basePrice: 220, yahoo: 'PFC.NS' },
];
